...
function PTSportToday({data,update,go,notify}){
  ...
  return <PTSportMotion identity="today"><div className="sport-home stack-lg">
    ...
    <div className="home-shortcuts scroll-reveal"><button onClick={()=>go('program')}><PTIcon name="book"/><span>Mon programme<small>{ptProgramShortcut(data)}</small></span><PTIcon name="arrow" size={16}/></button><button onClick={()=>prepare(true,'mobility',8)}><PTIcon name="spark"/><span>Juste 8 minutes<small>Garde lՎlan</small></span><PTIcon name="arrow" size={16}/></button></div>
